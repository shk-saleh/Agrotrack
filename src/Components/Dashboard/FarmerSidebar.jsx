...
import { LayoutDashboard, TrendingUp, LineChart, Cloud, Lightbulb, MessageSquare, Settings, LogOut } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { useAuth } from '../../Context/AuthContext';
import toast from 'react-hot-toast';

const FarmerSidebar = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="px-6 pb-2 pt-4 border-t border-gray-200">
        ...
        <button className="w-full flex items-center gap-3 px-4 py-2 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors mb-1">
          <Settings size={20} />
